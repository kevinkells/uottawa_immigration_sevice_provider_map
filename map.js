mapboxgl.accessToken = 'pk.eyJ1Ijoia2V2aW5rZWxscyIsImEiOiJjankwcTJjY20wNGF3M21wZTZtZDU3aTIyIn0.HZrH8fPX6bOjs-8DDVDrag'; // replace this with your access token
...
map.on('load', function () {
  ...
  map.on('click', function(e) {
    ...
    layers: ['franco', 'service-general'] // Add each layer here
  });
    ...
    .setHTML('<p>' + '<b>' + feature.properties.x_Type_en + '</b>' + '</p>'
      ...
      + '<a target=_blank href="' + feature.properties.x_Website_en + '">' + feature.properties.x_Website_en + '</a></br>'
      )
    .setLngLat(feature.geometry.coordinates)
    .addTo(map);
  });
